...
usage:
    python scripts/preemptive_message/main.py [--dry-run] [--limit N] [--user-keys=k1,k2]
...
from rexa.infra.broadcast_store import (  # noqa: E402
    SendLogRow,
    fetch_already_sent_user_keys,
    fetch_broadcast_targets,
    record_send_results,
)
from rexa.infra.kakao_event import KakaoEventClient, KakaoEventError  # noqa: E402

log = logging.getLogger("rexa")

KST = timezone(timedelta(hours=9))
AD_MESSAGE_WINDOW_START = 8 * 60
AD_MESSAGE_WINDOW_END = 20 * 60 + 50
